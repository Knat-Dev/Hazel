...
namespace Hazel {
	...
	void Renderer2D::DrawQuad(const Ref<QuadData3D>& data)
	{
		...
		s_Data.QuadVertexBufferPtr->Position = transformMtx * s_Data.QuadVertexPositions[0];
		...
		s_Data.QuadVertexBufferPtr->Position =  transformMtx * s_Data.QuadVertexPositions[1];
		s_Data.QuadVertexBufferPtr->Color = color;
		...
		s_Data.QuadVertexBufferPtr->Position = transformMtx * s_Data.QuadVertexPositions[2];
		s_Data.QuadVertexBufferPtr->Color = color;
		...
		s_Data.QuadVertexBufferPtr->Position = transformMtx * s_Data.QuadVertexPositions[3];
		s_Data.QuadVertexBufferPtr->Color = color;
